...
@Component({
    ...
    imports: [RegisterComponent, LoginComponent, Button, RouterLink, BadgeModule, OverlayBadgeModule, ToolbarModule, IconFieldModule, InputIconModule, InputTextModule],
    providers: [],
...
export class NavigationBarComponent implements OnInit, OnDestroy {
    ...
    constructor(private authService: AuthService, private toastService: ToastService, private cartService: CartService, private productsService: ProductsService) {}
